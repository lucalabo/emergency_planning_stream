...
_cleanup() {
    ...
    cp * ~/PycharmProjects/aspframework/gardener/bench_gardener_luca/config2/instance2/run1
    # cleanup shm files
    rm -rf /dev/shm/99bb458c-43b6-11f1-9d3b-ea2cee719830/
}
...
if [ -f ~/PycharmProjects/aspframework/gardener/bench_gardener_luca/config2/instance2/run1/00_finished.log ] ; then
...
mkdir /dev/shm/99bb458c-43b6-11f1-9d3b-ea2cee719830
cd /dev/shm/99bb458c-43b6-11f1-9d3b-ea2cee719830
mkdir input
mkdir output
cd output
...
cp ~/PycharmProjects/aspframework/gardener/instances/big-nd-200-001.lp /dev/shm/99bb458c-43b6-11f1-9d3b-ea2cee719830/input/big-nd-200-001.lp
cp /opt/runsolver /dev/shm/99bb458c-43b6-11f1-9d3b-ea2cee719830/input/runsolver
...
# execute run
env $myenv /dev/shm/99bb458c-43b6-11f1-9d3b-ea2cee719830/input/runsolver -w /dev/shm/99bb458c-43b6-11f1-9d3b-ea2cee719830/output/runsolver.log -v /dev/shm/99bb458c-43b6-11f1-9d3b-ea2cee719830/output/varfile.log -W 7205 --rss-swap-limit 25600 -d 5 --sigint /usr/bin/perf stat -B -e task-clock,cache-references,cache-misses,cycles,instructions,branches,faults,migrations,context-switches -o /dev/shm/99bb458c-43b6-11f1-9d3b-ea2cee719830/output/perf.log python3 gardener.py -m 2 --radius 5 --horizon 6 -r 1589915144 /dev/shm/99bb458c-43b6-11f1-9d3b-ea2cee719830/input/big-nd-200-001.lp 2> /dev/shm/99bb458c-43b6-11f1-9d3b-ea2cee719830/output/stderr.log 1> /dev/shm/99bb458c-43b6-11f1-9d3b-ea2cee719830/output/stdout.log &
child=$!
wait "$child"
