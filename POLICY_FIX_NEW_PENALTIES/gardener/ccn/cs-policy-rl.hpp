...
#ifndef NFD_DAEMON_TABLE_CS_POLICY_RL_HPP
#define NFD_DAEMON_TABLE_CS_POLICY_RL_HPP
...
/** \brief Least-Recently-Used (RL) replacement policy
 */
class RLPolicy final : public Policy
{
public:
  RLPolicy();
...
#endif // NFD_DAEMON_TABLE_CS_POLICY_RL_HPP
